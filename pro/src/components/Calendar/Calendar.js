...
import { waterConsumeMonthdApi } from '../../services/authApi';
...
const Calendar = () => {
    ...
    const selectManth = { start: firstDay, end: lastDay };
    console.log('selectDate :>> ', selectDate);
    

    useMemo(() => {
        console.log('selectManth :>> ', selectManth);
//   waterConsumeMonthdApi(selectManth);
// eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return (  
      <div>
          ...
          <div class="text-white">Month<span>  </span> Year</div>
